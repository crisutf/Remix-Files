...
namespace UC
{
    ...
    public:
        ...
        {
            return ((void* (*)(void*, __int64, unsigned int))(ImageBase + 0x521CFCC))(_a1, _a2, _a3);
        }
    ...
    public:
        ...
        inline TArray(int32 Size)
            : NumElements(0)
            , MaxElements(Size)
            , Data(FMemory::MallocForType<ArrayElementType>(Size))
        {
        }
    ...
    public:
        ...
        {
            if (!Data || Num + NumElements > MaxElements)
                Data = FMemory::ReallocForType<ArrayElementType>(Data, MaxElements = Num + NumElements);
        }
